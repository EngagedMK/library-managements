...
if (isset($_GET['search'])) {
    ...
    $sqlLogin = "SELECT * FROM TaiLieu WHERE tenTaiLieu LIKE '%$searchTerm%'";
                ...
                <?php include("components/toast.php");  ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="my-2 d-flex justify-content-end w-80 mr-3 ">
                            <td colspan="4"  style="text-align: center;"><a href="addBookManagement.php" class="p-2 bg-primary text-white rounded" style="display: flex; justify-content:cente; align-items:center" ><i class="fa fa-plus-square-o" aria-hidden="true" style="font-size:20px;margin-right: 8px; "></i></i>Thêm mới</a></td>
                        </div>
                            ...
                            <?php foreach ($result as $item) :?>
                                <tr>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center" >
                                        <a href="editBookManagement.php?id=<?php echo $item['idTaiLieu']; ?>" class="p-1 mx-1"><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size:20px;color: #F6C200"></i></a>  
